# Detailed Student Handout zh-TW — Day 2：Agent Governance Framework

> 台灣繁體中文完整詳細版學生講義。此檔完整保留
> `student-handout-detailed.md` 的章節、表格、schema、範例與 source boundary；
> `student-handout.md` 則由本長版摘要而成。
