...
> 給大二資訊工程學生的版本。這份 handout 會教你如何把一個「AI agent demo」轉成可以被企業系統使用、治理、審查與測試的 software system design。
...
```text
[ ] 我有寫出 Day 1-to-Day 2 gateway alignment note。
